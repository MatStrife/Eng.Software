    ...
    public partial class LoginPage : ContentPage
    {
        ...
        private async void userIdCheckEvent(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    await DisplayAlert("ATENÇÃO", "Usuário inválido", "OK");
                }
            }
        ...
        private async void Password_ClickedEvent(object sender, EventArgs e)
        {
            ...
            {
                warningLabel.Text = "Senhas devem ser iguais";
            ...
            else
            {
                try
                {
                  var return1 =  userData.updateUser(logesh, firstPassword.Text);
                    ...
                    if (return1)
                    {
                        await DisplayAlert("Senha atualizada","Senha atualizada","OK");
                    }
                }
                catch (Exception)
                {
            ...
            private async void LoginValidation_ButtonClicked(object sender, EventArgs e)
        {
            ...
            if (userNameEntry.Text != null && passwordEntry.Text != null)
            {
                ...
                if (validData)
                {
                    ...
                    App.SelectedUser = userData.GetSpecificUserFromUserName(userNameEntry.Text, passwordEntry.Text);
                ...
                else
                {
                    ...
                    //activityIndicator.IsVisible = false;
                    //activityIndicator.IsRunning = false;
                    await DisplayAlert("Erro no Login", "Usuário ou senha incorreto(s)", "OK");
                }
            ...
            {
                popupLoadingView.IsVisible = false;
                await DisplayAlert("ATENÇÃO", "Entre com usuário e senha", "OK");
            }
        }
